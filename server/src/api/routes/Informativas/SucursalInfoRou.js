...
SucursalInfoRou.get('/status/numero/:economico', SucursalInfoControllers.getSucursalDispositivos); // Consultar y retornar los dispositivos registrados por número económico -- /informe/status/numero/:economico
...
SucursalInfoRou.get('/status/dispositivos/:economico', SucursalInfoControllers.dispositivos); // Recorrer los dispositivos de una sucursal y actualizar la información si es necesario -- /informe/status/dispositivos/:economico
