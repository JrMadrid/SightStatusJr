...
UbicacionInfoRou.put('/ubicacion/editar/datos', ADMIN, CN.updateDatosUbicacion); // Editar los datos de la ubicación -- /informativa/ubicacion/editar/datos
UbicacionInfoRou.put('/ubicacion/editar/imagen', ADMIN, subir.Foto.single('imagen'), CN.updateImagenUbicacion); // Editar la imagen de la ubicación -- /informativa/ubicacion/editar/imagen
